...
// Source: github.ibm.com/pac/power-access-cloud/api/internal/pkg/pac-go-server/client/kubernetes (interfaces: Client)
...
import (
	...
	v1alpha1 "github.ibm.com/pac/power-access-cloud/api/apis/app/v1alpha1"
)
