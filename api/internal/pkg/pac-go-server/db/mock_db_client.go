...
// Source: github.ibm.com/pac/power-access-cloud/api/internal/pkg/pac-go-server/db (interfaces: DB)
...
import (
	...
	models "github.ibm.com/pac/power-access-cloud/api/internal/pkg/pac-go-server/models"
)
